...
export default function Pending(){
    ...
    const getAllRef = async()=>{
        ...
        const products = await axios.post(urlPointer + '/api/order/pendingdetails',data);
    ...
    const updateStatus =async(e)=>{
        ...
        const request = await axios.post(urlPointer + '/api/order/setworking',data);
                  ...
                  <div className='row'>
                      <div className='col-lg-12'>
                         {msg ? <div className='alert alert-success'>{msg}</div> : null} 
                          ...
                          :
                          <h1 style={{textAlign:'center'}}>No Pending</h1>
                        }
